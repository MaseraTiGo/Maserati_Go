...
"""
Django settings for tuoen project.
...
TUOEN_DIR = os.path.join(BASE_DIR, "tuoen")
...
ROOT_URLCONF = 'tuoen.urls'


API_TEMPLATE_DIR = os.path.join(TUOEN_DIR, "interface/template")
FILE_TEMPLATE_DIR = os.path.join(TUOEN_DIR, "file/template")
TEMPLATES = [
    {
